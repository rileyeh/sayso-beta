...
export default function Onboard() {
  ...
  // Auto-fill phone from user metadata
  useEffect(() => {
  ...
  return (
    <main className='mx-auto max-w-2xl p-6'>
      ...
      <p className='mt-2 text-[#6B4E31]'>
        Almost there! Add your kid(s). You can edit later.
      </p>

      <div className='mt-6 rounded-2xl bg-[#FFF8F0] p-5 shadow'>
        <label className='block text-sm font-medium text-[#6B4E31]'>
          Parent Phone
        </label>
        <input
        ...
        <div className='mt-4 flex gap-3'>
          ...
          <button
            ...
            onClick={submit}
            disabled={saving}
            className='rounded-xl bg-[#E63946] px-4 py-2 text-white shadow'
          >
      ...
      <p className='mt-3 text-xs text-neutral-500'>
        We’ll text you 3×/week. Reply to save a quote instantly.
      </p>
    </main>
  )
}
